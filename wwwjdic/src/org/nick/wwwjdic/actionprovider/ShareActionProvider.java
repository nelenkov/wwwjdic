...
import org.nick.wwwjdic.actionprovider.ActivityChooserModel.OnChooseActivityListener;
...
public class ShareActionProvider extends ActionProvider {
    ...
    public View onCreateActionView() {
        ...
        activityChooserView
                .setDefaultActionButtonContentDescription(R.string.shareactionprovider_share_with_application);
        activityChooserView
                .setExpandActivityOverflowButtonContentDescription(R.string.shareactionprovider_share_with);
    ...
    public void onPrepareSubMenu(SubMenu subMenu) {
        ...
        if (collapsedActivityCount < expandedActivityCount) {
            ...
            SubMenu expandedSubMenu = subMenu.addSubMenu(Menu.NONE,
