...
import org.nick.wwwjdic.actionprovider.ActivityChooserModel.ActivityChooserModelClient;
...
public class ActivityChooserView extends ViewGroup implements
    ...
    public ActivityChooserView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mListPopupMaxWidth = Math
                .max(resources.getDisplayMetrics().widthPixels / 2, resources
                        .getDimensionPixelSize(R.dimen.config_prefDialogWidth));
    }
    ...
    private class ActivityChooserViewAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            case ITEM_VIEW_TYPE_FOOTER:
                if (convertView == null
                    ...
                    convertView = LayoutInflater.from(getContext()).inflate(
                            R.layout.activity_chooser_view_list_item, parent,
                            false);
            ...
            case ITEM_VIEW_TYPE_ACTIVITY:
                if (convertView == null
                        || convertView.getId() != R.id.list_item) {
                    convertView = LayoutInflater.from(getContext()).inflate(
                            R.layout.activity_chooser_view_list_item, parent,
                            false);
                }
